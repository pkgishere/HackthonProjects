...
Winner: ? **1) Best Accessibility Hack by MICROSOFT
2. Best Philanthropic Hack by BLOOMBERG**
...
1. Creating a hardware which has a camera and integrated it with Google Assistant, so that it
...
3. From Extracted Text, applied Latent Dirichlet Allocation Algorithm to determine what is
...
1. Ishan Dikshit (?ishan.juit@gmail.com?) : Integrated Vision API, Coded for Latent Dirichlet
Allocation, Tested and debugged front end React Native Application, Cloud Integration and
deployment.
2. Prashant Garg (?pkgishere@gmail.com?): Integrated Google Assistant and Liked Google Mini
using Dialog-Flow, Developed Intent Model, Created webhook for back-end web Service
Integration.
3. Sanchit Narang (?sanchit.narang94@gmail.com?): Developed a front-end React Native App
which takes the photo and send it to the Cloud. Also Created a hardware to setup camera.
4. Suchir Inamdar (?inamdar.shuchir77@gmail.com?): Worked on Integration of Voice with
